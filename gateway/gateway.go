...
func NewGateway(serverVersion string, caPublicKeys, hostCertificate, hostPrivateKey []byte, revocationList string, statusFile string, statusDirectory string, geoipDatabase string) (*Gateway, error) {
